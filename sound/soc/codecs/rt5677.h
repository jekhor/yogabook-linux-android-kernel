...
#define RT5677_SPI_BUF_LEN 120

/* SPI Command */
enum {
	RT5677_SPI_CMD_16_READ = 0,
	RT5677_SPI_CMD_16_WRITE,
	RT5677_SPI_CMD_32_READ,
	RT5677_SPI_CMD_32_WRITE,
	RT5677_SPI_CMD_BURST_READ,
	RT5677_SPI_CMD_BURST_WRITE,
	RT5677_SPI_CMD_CODEC_READ = 8,
	RT5677_SPI_CMD_CODEC_WRITE,
};
...
struct rt5677_priv {
	...
	struct mutex index_lock, dsp_lock;
	const struct firmware *fw1, *fw2, *fw_par;
	...
	int pll_out;
	bool is_dsp_mode;
	int dsp_working_mode;
	int eq_working_mode;
	int vad_mode;
	bool is_vref_slow;
	enum rt5677_type type;
	unsigned int dsp_read;
